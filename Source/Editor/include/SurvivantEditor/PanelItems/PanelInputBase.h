...
namespace SvEditor::PanelItems
{
    ...
    public:
        ...
        ~PanelInputBase() override = default;

        void DisplayAndUpdatePanel() override = 0;
    ...
    template <class T, typename... Params>
    PanelInputBase<T, Params...>::PanelInputBase(const GetRefFunc& p_getRef, const Callback& p_callback)
        : m_callback(p_callback), m_getRef(p_getRef)
    {
    }

    template <class T, typename... Params>
    PanelInputBase<T, Params...>::PanelInputBase(const GetCopyFunc& p_getCopy, const Callback& p_callback)
    ...
    template <class T, typename... Params>
    void PanelInputBase<T, Params...>::DisplayAndUpdatePanel()
    {
        ImGui::SetNextItemWidth(-1);
    }

    template <class T, typename... Params>
    T& PanelInputBase<T, Params...>::GetRef()
    {
        return m_getRef();
    }

    template <class T, typename... Params>
    const T& PanelInputBase<T, Params...>::GetRef() const
    {
        return m_getRef();
    }
}
